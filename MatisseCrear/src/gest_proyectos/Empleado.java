 ...
 * Generation date: Wed Jan 13 13:59:47 2021
 */
...
public class Empleado extends com.matisse.reflect.MtObject {
    ...
    public float subeSueldoBruto(float incr){
        ...
        if(datos.isSueldo_bruto_anualDefaultValue()){
            return -1;
        }else{
            incr=incr/100;
        
        float nuevo_sueldo= datos.getSueldo_bruto_anual()*incr;
        nuevo_sueldo=nuevo_sueldo+datos.getSueldo_bruto_anual();
        datos.setSueldo_bruto_anual(nuevo_sueldo);
        return nuevo_sueldo;
        }
