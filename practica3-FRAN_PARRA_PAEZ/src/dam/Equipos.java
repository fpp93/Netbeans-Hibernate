...
public class Equipos  implements java.io.Serializable {
    ...
    public Equipos(String nombre, String ciudad, String conferencia, String division, Set<Jugadores> jugadoreses, Set<Partidos> partidosesForEquipoVisitante, Set<Partidos> partidosesForEquipoLocal) {
       this.nombre = nombre;
       this.ciudad = ciudad;
